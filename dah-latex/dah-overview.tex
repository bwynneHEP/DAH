...
\item Practical examples, e.g. temperature sensors, ultrasound sensors, FFT spectrum analysis, synthesizer, digital signal generators, light sensors, remote sensing.%, motion sensors, image processing, with CCDs.
