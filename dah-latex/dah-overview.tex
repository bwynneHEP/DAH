...
After all laboratory work is finished there will be a data-analysis project that can be performed outside of the laboratory.
...
While the checkpoints concentrated on specific data acquisition techniques and data handling methods the projects will allow you to progress towards building a small data analysis system. %DAQ and/or data analysis system.
